...
"""
bot_btc_passive.py
Passive Risk-First Straddle Runner for BTC 15m Markets.
"""
...
ENTRY_SIZE_SHARES = 5.0 # MARKET_CONFIG: max_size
LATE_REBALANCE_MAX_SUM = 1.01 # Confirmed 5m->0m param

def discover_market(target_crypto="btc"):
    """
...
def run():
    ...
    parser.add_argument("--entry-confirmations", type=int, default=2, help="Number of consecutive good hits before entry")
    parser.add_argument("--entry-min-dt", type=int, default=0, help="Min ms between confirmation hits")
    parser.add_argument("--entry-threshold", type=float, default=0.96, help="Max sum_px to allow entry")
