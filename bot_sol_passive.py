...
"""
bot_sol_passive.py
Passive Risk-First Straddle Runner for SOL 15m Markets.
"""
...
ENTRY_SIZE_SHARES = 15.0 # MARKET_CONFIG: max_size
LATE_REBALANCE_MAX_SUM = 1.01 # Confirmed 5m->0m param

def discover_market(target_crypto="sol"):
    """
...
def run():
    ...
    parser.add_argument("--entry-threshold", type=float, default=0.97, help="Max sum_px to allow entry")
