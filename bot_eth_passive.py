...
"""
bot_eth_passive.py
Passive Risk-First Straddle Runner for ETH 15m Markets.
"""
...
ENTRY_SIZE_SHARES = 20.0 # MARKET_CONFIG: max_size
LATE_REBALANCE_MAX_SUM = 1.01 # Confirmed 5m->0m param

def discover_market(target_crypto="eth"):
    """
...
def run():
    ...
    parser.add_argument("--entry-threshold", type=float, default=0.98, help="Max sum_px to allow entry")
